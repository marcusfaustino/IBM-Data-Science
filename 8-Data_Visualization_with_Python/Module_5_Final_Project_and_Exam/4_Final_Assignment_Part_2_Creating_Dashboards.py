	...
	# Hint:Use Vehicle_Type and Advertising_Expenditure columns
        ...
        R_chart3 = dcc.Graph(
            figure=px.pie(exp_rec,
                          ...
                          labels={'Vehicle_Type': 'Vehicle Type', 'Automobile_Sales': 'Average Automobile Sales'},
                          title='Distribution of Total Advertising Expenditure by Vehicle Type')
        )
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
        ...
        Y_chart3 = dcc.Graph(figure=px.bar(avr_vdata,
                                           ...
                                           y='Automobile_Sales',
                                           labels={'Vehicle_Type': 'Vehicle Type', 'Automobile_Sales': 'Average Automobile Sales'},
                                           title=f'Average Vehicles Sold by Vehycle Type in the year {input_year}'))

    # Total Advertisement Expenditure for each vehicle using pie chart
         # grouping data for plotting.
         # Hint:Use the columns Vehicle_Type and Advertising_Expenditure
        exp_data=yearly_data.groupby('Vehicle_Type')['Advertising_Expenditure'].sum().reset_index()
        Y_chart4 = dcc.Graph(figure=px.pie(data_frame=exp_data,
                                           names='Vehicle_Type',
                                           values='Advertising_Expenditure',
